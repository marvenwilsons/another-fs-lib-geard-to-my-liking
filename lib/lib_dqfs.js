...
// libs
    ...
    lib.ls = (absolutePath,options) => {
        ...
        methods.sortByName = (modes) => {
            
        }

        methods.sortBySize = (modes) => {

        } 

        methods.sortByType = (modes) => {

        }

        methods.sortByDateCreated = (modes) => {

        }

        methods.sortByDateModified = (modes) => {

        }

        methods.groupByType = (modes) => {

        }

        methods.groupByMonth = (modes) => {

        }

        methods.groupByYear = (modes) => {

        }

        methods.showOnly = (key) => {
