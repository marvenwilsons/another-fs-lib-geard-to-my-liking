...
// libs
    ...
    lib.touch = (file,content) => {
        ...
        content != undefined && typeof content != 'string' && err('error touch: content should be a string')
        ...
        const c1 = () => {
            ...
            fs.existsSync(newPath) ? 
                ...
                fs.writeFileSync(`${newPath.trim()}${pathFile}`,content != undefined ? content : '','utf-8')
