...
const d = (() => {
    ...
    lib.mv = (frm,to) => {
        ...
        // // rename a file
        // frm.dir == to.dir && frm.ext != '' && to.ext != '' && frm.base != to.base && (() => {
        //     fs.renameSync()
        // })() 
        ...
        // // move a dir
        // frm.dir != to.dir && frm.ext == '' && to.ext == '' && frm.base == to.base && (() => {
        //     console.log(`move a dir -- ${frm.base} ${to.base}`)
        // })() 

        // // rename and move a dir
        // frm.dir != to.dir && frm.ext == '' && to.ext == '' && frm.base != to.base && (() => {
        //     console.log(`rename and move dir -- ${frm.base} ${to.base}`)
        // })() 

        // // rename and move a file
        // frm.dir != to.dir && frm.ext != '' && to.ext != '' && frm.base != to.base && (() => {
        //     console.log(`rename and move a file -- ${frm.base} ${to.base}`)
        // })()
    }
