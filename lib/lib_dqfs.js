...
// libs
    ...
    lib.ls = (absolutePath,options) => {
        ...
        methods.sortByName = (mode) => {
        
        }

        methods.sortBySize = (mode) => {

        } 

        methods.sortByType = (mode) => {

        }

        methods.sortByDateCreated = (mode) => {

        }

        methods.sortByDateModified = (mode) => {

        }

        methods.groupByType = (mode) => {

        }

        methods.groupByMonth = (mode) => {

        }

        methods.groupByYear = (mode) => {
